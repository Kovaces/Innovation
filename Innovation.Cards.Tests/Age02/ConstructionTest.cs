...
namespace Innovation.Cards.Tests
{
	...
	public class ConstructionTest
	{
		...
		public void Card_ConstructionAction1()
		{
			...
			var result = new Construction().Actions.ToList()[0].ActionHandler(new CardActionParameters { TargetPlayer = testGame.Players[1], Game = testGame, ActivePlayer = testGame.Players[0], PlayerSymbolCounts = new Dictionary<IPlayer, Dictionary<Symbol, int>>() });
		...
		public void Card_ConstructionAction1_EmptyHand()
		{
			...
			Assert.AreEqual(true, result.OtherPlayerActed);  // still draws a 2 
