...
namespace Innovation.Cards.Tests
{
	...
	public class PhilosophyTest
	{
		...
		public void Card_PhilosophyAction1_NothingHappens()
		{
			...
			var result = new Philosophy().Actions.ToList()[0].ActionHandler(new CardActionParameters { TargetPlayer = testGame.Players[0], Game = testGame, ActivePlayer = testGame.Players[0], PlayerSymbolCounts = new Dictionary<IPlayer, Dictionary<Symbol, int>>() });
